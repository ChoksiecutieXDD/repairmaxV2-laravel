<div class="w-full">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        ...
        <div class="bg-white p-6 rounded-2xl border border-brand-200 shadow-sm flex flex-col justify-between">
    ...
    <div class="mt-12 mb-12"
        ...
        <div class="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div class="relative w-full lg:max-w-md shrink-0">
                ...
                <input type="text" x-model="search" placeholder="Search for screens, battery replacement..." 
                    class="w-full pl-11 pr-10 py-3 bg-white border border-brand-200 rounded-[1.25rem] focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all outline-none text-xs font-bold text-gray-900 shadow-sm">
        ...
        <div class="flex flex-wrap items-center gap-1.5 bg-white p-1.5 rounded-[1.25rem] mb-8 w-full border border-brand-200/80 shadow-sm">
        ...
        <div class="relative min-h-[300px]">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" x-show="filteredServices.length > 0">
                <template x-for="service in filteredServices" :key="service.id">
                    <div class="bg-white rounded-[2rem] border border-brand-200 shadow-sm hover:shadow-lg hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col group">
            ...
            <!-- Empty State -->
            <div class="flex flex-col items-center justify-center text-center py-16 px-4 bg-white border border-brand-200 rounded-[2rem] shadow-sm"
                 x-show="filteredServices.length === 0" 
                 x-cloak>
                <div class="w-16 h-16 bg-gray-50 border border-dashed border-brand-250 rounded-2xl flex items-center justify-center mb-4">
