<x-layouts.landing title="24/7 AI Diagnostic Support | Repairmax">
    <main class="relative pt-32 lg:pt-40 pb-24 md:pb-32 overflow-hidden bg-[#020617]">
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="bg-white/[0.03] backdrop-blur-md rounded-[3rem] p-8 md:p-16 border border-white/10 text-white shadow-2xl relative overflow-hidden text-left">
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <!-- Left Copy & CTAs -->
                    <div>
                        <div class="w-14 h-14 bg-white/5 text-white rounded-2xl flex items-center justify-center mb-8 border border-white/10 shadow-lg shadow-blue-500/5 flex items-center justify-center">
                        ...
                        <p class="text-gray-400 mb-8 leading-relaxed text-sm md:text-base font-medium">
                        ...
                        <ul class="space-y-6">
                            <li class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <span class="text-xs text-gray-450 leading-relaxed mt-0.5 block font-medium">
