    ...
    <div class="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
        <div x-show="show"
            ...
            <div class="flex gap-3 justify-end">
                <button @click="show = false" class="px-4 py-2 bg-white text-gray-700 font-medium rounded-full border border-gray-300 hover:bg-gray-50 transition-colors">
                    Cancel
                </button>
                <button @click="$wire.call(confirmMethod); show = false"
                    class="px-4 py-2 bg-gray-900 text-white font-medium rounded-full hover:bg-gray-800 transition-colors"
                    x-text="confirmText">
                </button>
            </div>
        </div>
